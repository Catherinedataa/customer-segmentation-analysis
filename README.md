...
It identifies actionable insights in the following ways: customer profile and behavior, purchase pattern, effectiveness of marketing campaigns, amongst others. With segmentations through clusters, Axis Retail Solutions would seek to create targeted marketing activities towards engagement levels and revenue growth. These were major aspects the analysis had revolved around:
...
The enriched dataset, complemented by an ERD table for reference, informed the dashboard in a way that links customer traits to actionable insights.
...
These findings highlight opportunities to tailor strategies for maximizing engagement and profitability across all customer segments.
